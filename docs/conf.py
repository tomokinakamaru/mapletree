# -*- coding: utf-8 -*-
#
# MapleTree documentation build configuration file, created by
...
latex_documents = [
  ('index', 'MapleTree.tex', u'MapleTree Documentation',
...
man_pages = [
    ('index', 'mapletree', u'MapleTree Documentation',
     [u'TomokiNakamaru'], 1)
]
...
texinfo_documents = [
  ('index', 'MapleTree', u'MapleTree Documentation',
   u'TomokiNakamaru', 'MapleTree', 'One line description of project.',
   'Miscellaneous'),
]
